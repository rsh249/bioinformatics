...
Get data for mitochondria from wolves and chimps. Build a blast database from one and query the other. Then build a map of the blast hits.
...
```{bash, eval =FALSE}
ncbi-blast-2.7.1+/bin/makeblastdb.exe -in data/vulpes.fa -dbtype nucl -title vulpes


ncbi-blast-2.7.1+/bin/blastn.exe -db data/vulpes.fa -query data/pan.fa -outfmt 6 -max_target_seqs 1000 -evalue 10 -ungapped -num_threads 2 -out blastout.tab    
