...
./raxml -f a -p 12345 -x 12345 -N 200 -s out.phy -m GTRCAT -n boot1
...
```{R, eval=TRUE}
library(ggtree)
best <- read.tree('RAxML_bestTree.tree')
best
...
Using [this file]() construct a phylogenetic tree and plot it using ggtree. Post the tree to #plots channel on Slack by Monday.